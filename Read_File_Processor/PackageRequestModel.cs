...
namespace Read_File_Processor
{
    ...
    public class WiproPackageRequestModel
    {

        public metadata metadata { get; set; }

        private List<WiproData> _data;
        public List<WiproData> data
        {
            get
            {
                if (_data == null)
                {
                    _data = new List<WiproData>();
                }
                return _data;
            }
            set
    ...
    public class Data
    {
        ...
        public string datascrappedvalue { get; set; }
    ...
    {
        public string checkinitiated  { get; set; }
    }
